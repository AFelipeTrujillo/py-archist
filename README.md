...
**Using curl:**
```bash
curl -O [https://raw.githubusercontent.com/AFelipeTrujillo/py-archist/main/py_archist.sh](https://raw.githubusercontent.com/AFelipeTrujillo/py-archist/main/py_archist.sh)
```
